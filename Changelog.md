...
#### Core changes
- [Fix bug in jwplayer data parsing filled only with video that should be url_transparent. If jwplayer type field is video/url, set extension as url. Minor fixes in release and build jobs](https://github.com/yt-dlp/yt-dlp/commit/d675113f42288921e925c399c886f220d6133972) by [pukkandan](https://github.com/pukkandan)
- [Version bump](https://github.com/yt-dlp/yt-dlp/commit/6a3c8167bc165bbc2de610043b55f0a513248723) by [pukkandan](https://github.com/pukkandan)
